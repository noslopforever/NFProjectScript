...
namespace nf.protoscript.translator.expression
{
    ...
    public abstract class ExprCodeGeneratorAbstract
    {
        ...
        public class Stage
        {
            ...
            /// <summary>
            /// Generated code of this stage.
            /// </summary>
            // TODO Codes generated by a stage should be organized by different groups: think about codes with try-catch-finally stages.
            public virtual IReadOnlyList<string> Results { get { return _results; } }

            // implementation of Results
            protected List<string> _results = new List<string>();

            /// <summary>
            /// Add one code-line to this stage.
            /// </summary>
            /// <param name="InCodeLn"></param>
            public void AddCodeLine(string InCodeLn)
            {
                _results.Add(InCodeLn);
            }
        ...
        protected abstract void EmitConstString(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, TypeInfo InValueType, string InTextString);
        ...
        /// <returns></returns>
        protected abstract void EmitConstValueCode(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, TypeInfo InValueType, string InConstValueString);
        ...
        /// <returns></returns>
        protected abstract void EmitConstInfo(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, TypeInfo InValueType, Info InConstInfo);
        ...
        protected abstract void EmitVarRef(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, Info InScope, string InVarID, EInstructionUsage InUsage);
        ...
        protected abstract void EmitMemberRef(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, ISTNodeResultPlaceholder InHost, string InMemberId, EInstructionUsage InUsage);
        ...
        protected abstract void EmitAssign(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, ISTNodeResultPlaceholder InLhsCode, ISTNodeResultPlaceholder InRhsCode);
        ...
        protected abstract void EmitBinOp(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, string InOpCode, ISTNodeResultPlaceholder InLeftCode, ISTNodeResultPlaceholder InRightCode);
        ...
        /// <returns></returns>
        /// <param name="InRhsCode"></param>
        protected abstract void EmitUnaryOp(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, string InOpCode, ISTNodeResultPlaceholder InRhsCode);
        ...
        protected abstract void EmitCall(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, ISTNodeResultPlaceholder InSourceCode, ISTNodeResultPlaceholder[] InParamCodes);
        ...
        /// <returns></returns>
        /// <param name="InParamCodes"></param>
        protected abstract void EmitNew(Stage InStage, ISTNodeResultPlaceholder InTargetPlaceholder, Info InArchetype, ISTNodeResultPlaceholder[] InParamCodes);
        ...
        /// <param name="InStageType"></param>
        /// <param name="InSTNode"></param>
        protected virtual Stage EnterStage(EStageType InStageType, ISyntaxTreeNode InSTNode)
        {
        ...
        {
            public ValueNodeVisitor(Stage InStage, ExprCodeGeneratorAbstract InHostGenerator, ISTNodeResultPlaceholder InTargetPlaceholder)
            {
                HostStage = InStage;
            ...
            public virtual void Visit(STNodeConstant InConst)
            {
                ...
                {
                    HostGenerator.EmitConstValueCode(HostStage, TargetPlaceholder, InConst.Type, "null");
                }
                else if (InConst.Value.GetType().IsValueType)
                {
                    Type valueType = InConst.Value.GetType();

                    HostGenerator.EmitConstValueCode(HostStage, TargetPlaceholder, InConst.Type, InConst.Value.ToString());
                }
                else if (InConst.Value is string)
                {
                    HostGenerator.EmitConstString(HostStage, TargetPlaceholder, InConst.Type, InConst.Value as string);
                }
                else if (InConst.Value is Info)
                {
                    HostGenerator.EmitConstInfo(HostStage, TargetPlaceholder, InConst.Type, InConst.Value as Info);
                }
            }

            public virtual void Visit(STNodeVar InVarNode)
            {
                HostGenerator.EmitVarRef(HostStage, TargetPlaceholder, HostGenerator.Scope, InVarNode.IDName, EInstructionUsage.Load);
            }
            ...
            public virtual void Visit(STNodeMemberAccess InSubNode)
            {
                ...
                ValueNodeVisitor subVisitor_L = new ValueNodeVisitor(HostStage, HostGenerator, lPlaceholder);
                VisitByReflectionHelper.FindAndCallVisit(InSubNode.LHS, subVisitor_L);

                HostGenerator.PreAccessPlaceholder(lPlaceholder);
                HostGenerator.EmitMemberRef(HostStage, TargetPlaceholder, lPlaceholder, InSubNode.MemberID, EInstructionUsage.Load);
            ...
            public virtual void Visit(STNodeAssign InAssignNode)
            {
                ...
                ValueNodeVisitor rhsVisitor = new ValueNodeVisitor(HostStage, HostGenerator, rhsPlaceholder);
                VisitByReflectionHelper.FindAndCallVisit(InAssignNode.RHS, rhsVisitor);

                LHSNodeVisitor lhsVisitor = new LHSNodeVisitor(HostStage, HostGenerator, lhsPlaceholder);
                ...
                HostGenerator.EmitAssign(HostStage, TargetPlaceholder, lhsPlaceholder, rhsPlaceholder);
            ...
            public virtual void Visit(STNodeBinaryOp InBinOpNode)
            {
                ...
                ValueNodeVisitor subVisitor_R = new ValueNodeVisitor(HostStage, HostGenerator, rPlaceholder);
                VisitByReflectionHelper.FindAndCallVisit(InBinOpNode.RHS, subVisitor_R);

                HostGenerator.PreAccessPlaceholder(rPlaceholder);
                HostGenerator.PreAccessPlaceholder(lPlaceholder);
                HostGenerator.EmitBinOp(HostStage, TargetPlaceholder, InBinOpNode.OpCode, lPlaceholder, rPlaceholder);
                HostGenerator.PostAccessPlaceholder(lPlaceholder);
        ...
        class LHSNodeVisitor
            : ValueNodeVisitor
        {
            public LHSNodeVisitor(Stage InHostStage, ExprCodeGeneratorAbstract InHostGenerator, ISTNodeResultPlaceholder InTargetPlaceholder)
                : base(InHostStage, InHostGenerator, InTargetPlaceholder)
            {
            }

            public override void Visit(STNodeVar InVarNode)
            {
                HostGenerator.EmitVarRef(HostStage, TargetPlaceholder, HostGenerator.Scope, InVarNode.IDName, EInstructionUsage.Set);
            }
            ...
            public override void Visit(STNodeMemberAccess InSubNode)
            {
                ...
                HostGenerator.PreAccessPlaceholder(lPlaceholder);
                HostGenerator.EmitMemberRef(HostStage, TargetPlaceholder, lPlaceholder, InSubNode.MemberID, EInstructionUsage.Set);
                HostGenerator.PostAccessPlaceholder(lPlaceholder);
            }
        ...
        class StatementNodeVisitor
        {
            ...
            {
                var stage = HostGenerator.EnterStage(EStageType.Statement, InOtherSTNode);

                ValueNodeVisitor valueNodeVisitor = new ValueNodeVisitor(stage, HostGenerator, null);
            ...
            {
                var stage = HostGenerator.EnterStage(EStageType.Block, InNodes);
        ...
        class FunctionBodyVisitor
        {
            ...
            public void Visit(ISyntaxTreeNode InOtherSTNode)
            {
                var stage = HostGenerator.EnterStage(EStageType.Function, InOtherSTNode);
