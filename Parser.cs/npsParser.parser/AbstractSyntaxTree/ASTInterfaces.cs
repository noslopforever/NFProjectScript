...
namespace nf.protoscript.parser
{
    ...
    /// <summary>
    /// Interface for Abstract Syntax Tree (AST) parsers.
    /// </summary>
    public interface IASTParser
    {
       ...
       /// <returns>The parsed syntax tree node.</returns>
        ISyntaxTreeNode ParseTokens(IReadOnlyList<IToken> InTokens, ref int InStartIndex);
    ...
    //            new TokenParserRegex(@"[$a-zA-Z_][a-zA-Z0-9_$]*", "Identifier")
